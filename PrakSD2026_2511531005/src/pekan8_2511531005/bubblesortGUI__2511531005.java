...
public class bubblesortGUI__2511531005 extends JFrame {
	 ...
	 * Create the frame.
	 */
	public bubblesortGUI__2511531005() {
		...
		setButton_1005.addActionListener(e -> setArrayFromInput_1005());
		
		stepButton_1005.addActionListener(e -> performStep_1005());
		
		resetButton_1005.addActionListener(e -> reset_1005());
				
	}
	
	private void setArrayFromInput_1005() {
		
		String text = inputField_1005.getText().trim();
		...
		for (int k = 0; k < array_1005.length; k++) {
			...
			labelArray_1005[k].setOpaque(true);
			labelArray_1005[k].setBackground(Color.white);
	...
	private void updateLabels_1005() {
	...
	public void resetHightlights_1005() {
		for(JLabel label : labelArray_1005) {
	...
	private Object arrayToString_1005(int[] arr_1005) {
	...
	public static void main (String[] args) {
		SwingUtilities.invokeLater(() -> {
			bubblesortGUI__2511531005  gui = new bubblesortGUI__2511531005();
			gui.setVisible(true);
		});
	}
